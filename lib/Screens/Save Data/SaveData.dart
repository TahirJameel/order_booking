...
import '../New Order/NewOrder.dart';
  ...
  void filterData() {
    ...
    filteredData = savedData.where((data) {
      ...
      return orderId.toString().startsWith(idQuery) &&
          ...
          data['name']!.toString().toLowerCase().startsWith(nameQuery);
    }).toList();
    ...
    try {
      ...
      for (var data in filteredData) {
        try {
          ...
          String isaleman = data['isalesman']?.toString() ?? '';
    ...
    return Scaffold(
                                              ...
                                              CupertinoButton(
                                                ...
                                                onPressed: () async {
                                                  if (orderData
                                                    ...
                                                    if (result) {
                                                      // Update the local database and the original list with modified data
                                                      await fetchDataFromDatabase();
                                                      setState(() {});
                                                    }
                                                  }
      ...
      floatingActionButton: FloatingActionButton.extended(
        onPressed: () {
          Get.defaultDialog(
            title: 'Confirmation',
            content: const Text('Do you really want to upload the data.'),
